$ListOfCompanys = @{}
    ...
    "Nexer Data Management AB"              = @{"OU" = "OU=Users,OU=Data Management,OU=SigmaGroup,DC=sigma,DC=local";                                                "Domain" = "nexergroup.com";        "Database" = ""};
    ...
    "Nexer Group S.A.S"                     = @{"OU" = "OU=Users,OU=Nexer Colombia,OU=SigmaGroup,DC=sigma,DC=local";                                                 "Domain" = "nexergroup.com";        "Database" = "S456"};
    ...
    "Nexer Unified Commerce AB"             = @{"OU" = "OU=Users,OU=Unified Commerce,OU=SigmaGroup,DC=sigma,DC=local";                                               "Domain" = "nexergroup.com";        "Database" = "S411"};
