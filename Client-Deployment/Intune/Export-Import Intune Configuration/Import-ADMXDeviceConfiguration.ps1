...
Function Add-GroupPolicyConfigurations()
{
...
#>
    ...
    try {
        ...
        write-host "No JSON specified, please specify valid JSON for the ADMX Configuration Policy..." -f Red
...
write-host
write-host "ADMX Configuration Policy '$DisplayName' Found..." -ForegroundColor Yellow
write-host
$JSON_Output
write-host
Write-Host "Adding ADMX Configuration Policy '$DisplayName'" -ForegroundColor Yellow
Add-GroupPolicyConfigurations -JSON $JSON_Output
