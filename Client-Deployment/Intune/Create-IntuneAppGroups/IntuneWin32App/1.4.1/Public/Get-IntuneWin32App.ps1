                    ...
                    if ($Win32MobileApps -ne $null) {
                        ...
                        if ($Win32MobileApps -ne $null) {
                            foreach ($Win32MobileApp in $Win32MobileApps) {
                                ...
                                $Win32App | Add-Member -MemberType NoteProperty -Name categories -Value (Invoke-IntuneGraphRequest -APIVersion "Beta" -Resource "mobileApps/$($Win32MobileApp.id)/categories" -Method "GET").value
