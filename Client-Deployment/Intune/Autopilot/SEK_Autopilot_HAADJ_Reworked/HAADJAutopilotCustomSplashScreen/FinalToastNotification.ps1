...
$Text = "Hi $user, your device is now ready. Click here to restart and get started."
$Timeout = 1800

# Remove Run command from registry

Remove-ItemProperty "HKCU:\Software\Microsoft\Windows\CurrentVersion\Run" -Name '!Splash' -Force

# Create tag in script folder
New-Item -Path $PSScriptRoot -Name "AADHybridLockOOBE.tag" -ItemType File -Force
