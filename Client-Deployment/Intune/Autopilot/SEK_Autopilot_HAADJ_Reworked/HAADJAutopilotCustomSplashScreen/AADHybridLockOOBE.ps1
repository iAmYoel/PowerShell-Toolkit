...
$UI.TextBlock4.Text = "Do not disconnect device from network. If it takes more than 30 minutes, contact support."
...
$TextArray = @(
    ...
    "Waiting for Azure AD Connect sync to happen"
    "Also waiting for BitLocker to encrypt all disks"
    "The process may take up to 30 minutes..."
    "Your PC will restart when it's done"
