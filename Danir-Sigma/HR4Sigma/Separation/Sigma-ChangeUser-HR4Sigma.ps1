...
. "C:\hr4sigma\library\Sigma-Company-HR4Sigma.ps1"
...
# Load functions
    ...
    function set-account-memberof
    {
        ...
        $AddGroups += switch ($company) {
            ...
            "Sigma Civil AB"                        {
                                                        if($city -like "Stockholm"){ "Civil Office Stockholm Liljeholmen" }
                                                        else{ "Civil Office $city" }

                                                        foreach ($cg in $sgcivilgroup){Get-ADUser -Identity $alias | Add-ADPrincipalGroupMembership -memberof $cg}
                                                    }
...
$log= "C:\hr4sigma\log\sigma-change_user_HR4Sigma$logdate.log"
$logerror = "C:\hr4sigma\log\sigma-change_user_error_HR4Sigma$logdate.log"
$loginfo = "C:\hr4sigma\log\sigma-change_user_info_HR4Sigma$logdate.log"
