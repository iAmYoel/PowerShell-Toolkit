$ListOfCompanys = @{}
    ...
    "Sigma Connectivity Group AB"           = @{"OU" = "OU=Users,OU=Sigma Connectivity,OU=SigmaGroup,DC=sigma,DC=local";                                           "Domain" = "sigmaconnectivity.se";  "Database" = ""};
    ...
    "Sigma Connectivity Ltd"                = @{"OU" = "OU=Users,OU=Connectivity UK,OU=Sigma Connectivity,OU=SigmaGroup,DC=sigma,DC=local";                        "Domain" = "sigmaconnectivity.com"; "Database" = ""};
    ...
    "Sigma Connectivity Medtech AB"         = @{"OU" = "OU=Users,OU=Connectivity MedTech,OU=Sigma Connectivity,OU=SigmaGroup,DC=sigma,DC=local";                   "Domain" = "sigmaconnectivity.se";  "Database" = ""};
    ...
    "Sigma Embedded Engineering Future AB"  = @{"OU" = "OU=Users,OU=Embedded Engineering Future,OU=Sigma Embedded Engineering,OU=SigmaGroup,DC=sigma,DC=local";    "Domain" = "sigma.se";              "Database" = "SEEF"};
    ...
    "Sigma Industry Development AB"         = @{"OU" = "OU=Users,OU=Development,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                "Domain" = "sigma.se";              "Database" = "S742"};
    "Sigma Industry East AB"                = @{"OU" = "OU=Users,OU=East,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                       "Domain" = "sigma.se";              "Database" = "S743"};
    ...
    "Sigma Industry Evolve AB"              = @{"OU" = "OU=Users,OU=Evolve,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                     "Domain" = "sigma.se";              "Database" = "S745"};
    ...
    "Sigma Industry Innovation AB"          = @{"OU" = "OU=Users,OU=Innovation,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                 "Domain" = "sigma.se";              "Database" = "S747"};
    "Sigma Industry North AB"               = @{"OU" = "OU=Users,OU=North,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                      "Domain" = "sigma.se";              "Database" = "S746"};
    "Sigma Industry Power and Energy AB"    = @{"OU" = "OU=Users,OU=Power and Energy,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                           "Domain" = "sigma.se";              "Database" = ""};
    "Sigma Industry Smart AB"               = @{"OU" = "OU=Users,OU=Smart,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                                      "Domain" = "sigma.se";              "Database" = "S742"};
    ...
    "Crew by Sigma AB"                      = @{"OU" = "OU=Users,OU=Crew by Sigma AB,OU=West,OU=Sigma Industry,OU=SigmaGroup,DC=sigma,DC=local";                   "Domain" = "sigma.se";              "Database" = "CREW"};
